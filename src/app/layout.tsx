...
export const metadata: Metadata = {
  title: "YouTube Ads Management & Campaign Optimization | AdHub",
  description: "Maximize your YouTube advertising ROI with data-driven campaigns, expert video creation, and real-time optimization. Professional ad management for businesses.",
  keywords: "YouTube ads, YouTube advertising, video marketing, ad management, campaign optimization",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763726096121-typrfr5f.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763726096121-typrfr5f.jpg"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "YouTube Ads Management & Campaign Optimization | AdHub",
    description: "Maximize your YouTube advertising ROI with data-driven campaigns and expert optimization strategies.",
    type: "website",
    siteName: "AdHub",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763726096121-typrfr5f.jpg",
        alt: "YouTube advertising dashboard"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "YouTube Ads Management & Campaign Optimization",
    description: "Professional YouTube advertising services to drive growth",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763726096121-typrfr5f.jpg"]
  }
};
